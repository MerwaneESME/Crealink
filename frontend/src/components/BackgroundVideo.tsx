...
const BackgroundVideo = ({ customVideo = "/videoplayback.webm" }: BackgroundVideoProps) => {
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        <video
          ...
          className={`absolute w-[300%] h-[300%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 object-cover ${
